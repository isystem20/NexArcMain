...
namespace NEXARC.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly NEXARCDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = NEXARCConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NEXARCDbContext context)
        {
            _context = context;
        }
